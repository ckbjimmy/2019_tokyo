...
class LogisticRegressionEstimator(CausalEstimator):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.logger.info("INFO: Using Logistic Regression Estimator")
    ...
    def _estimate_effect(self):
        ...
        features = np.concatenate((treatment_2d, self._observed_common_causes),
                                  axis=1)
        self._linear_model = linear_model.LogisticRegression()
        ...
        estimate = CausalEstimate(estimate=coefficients[0][0],
